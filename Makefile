# This Makefile is for the SNOW extension to perl.
#
...
#     AUTHOR => q[Tim Skirvin <tskirvin@fnal.edu>]
#     BUILD_REQUIRES => {  }
#     DISTNAME => q[SNOW]
#     NAME => q[SNOW]
#     PREREQ_PM => { ServiceNow=>q[1.08] }
#     VERSION_FROM => q[lib/SNOW.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/SNOW.pm \
	lib/SNOW/Incident.pm
...
TO_INST_PM = lib/SNOW.pm \
	lib/SNOW/Incident.pm

PM_TO_BLIB = lib/SNOW/Incident.pm \
	blib/lib/SNOW/Incident.pm \
	lib/SNOW.pm \
	blib/lib/SNOW.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/SNOW/Incident.pm $(INST_MAN3DIR)/SNOW::Incident.$(MAN3EXT) \
	  lib/SNOW.pm $(INST_MAN3DIR)/SNOW.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               SNOW' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            undef' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           ~' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Tim Skirvin <tskirvin@fnal.edu>' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    ServiceNow:  1.08' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Tim Skirvin &lt;tskirvin@fnal.edu&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="ServiceNow::" VERSION="1.08" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/SNOW/Incident.pm blib/lib/SNOW/Incident.pm \
	  lib/SNOW.pm blib/lib/SNOW.pm 
